...
@Composable
fun DeleteKanbanDialog (
    kanban: Kanban,
    kanbanViewModel: KanbanViewModel,
    setShowDialog: (Kanban?) -> Unit,
) {

    Dialog(onDismissRequest = { setShowDialog(null) }) {
        ...
        Surface(
            ...
            Column(
                ...
                Text(
                    text = stringResource(id = R.string.delete_kanban) + ": \"" + kanban.name + "\" ?",
                ...
                Row (
                    ...
                    Text(
                        modifier = Modifier
                            .padding(horizontal = 10.dp, vertical = 10.dp)
                            .clickable {
                                kanbanViewModel.deleteKanban( kanban, setShowDialog)
                            },
